<h2><a href="https://leetcode.com/problems/minimum-operations-to-form-subset-sum-ii">Minimum Operations to Form Subset Sum II</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are given an integer array <code>nums</code> and an integer <code>sum</code>.</p>
